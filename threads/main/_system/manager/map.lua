---@class (exact) sirinMapMgr
---@field clearLayer fun(pMap: CMapData, wLayerIndex: integer)
local sirinMapMgr = {}

---@param pMap CMapData
---@param wLayerIndex integer
function sirinMapMgr.clearLayer(pMap, wLayerIndex)
	repeat
				...
				repeat
					...
					if pObj.m_ObjID.m_byKind == OBJ_KIND.item then
						...
						elseif pObj.m_ObjID.m_byID == ID_ITEM.return_gate then
							...
							print(string.format("Lua. sirinMapMgr.clearLayer(...): Invalid item object ID %d", pObj.m_ObjID.m_byID))
						end
					else
						...
						elseif pObj.m_ObjID.m_byID == ID_CHAR.trap then
							...
							print(string.format("Lua. sirinMapMgr.clearLayer(...): Invalid character object ID %d", pObj.m_ObjID.m_byID))
						end
					end
				until false
			until true
