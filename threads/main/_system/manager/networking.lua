...
local protoTypes = {
	["sirin.proto.customWindows"] = {
		4096,
		{ 'u32', { true, { 'u32', 'u32', 's', 'u32', 'u32', 'u32', 'u32', 'pu32', 's', 's', 's', { true, { 'u32' ,'pu32' } },
			{ true, { 'u32', 'pu32', 's', 'u32', 'u32', 's', 'pu32', { false, { { false, { 's', 'u32' } }, { true, { 'u32', 's', 's', 'u32' } } } }, 'u32', 'u32', 'u32', 'pu32', 'pu32', 'pu32', 'b', 'b', 'u32', 'u32', 'pu32', 'pi32' } } } } },
		{ 'ct', { true, { 'data', 'id', 'visualVer', 'name', 'width', 'height', 'headerWindowID', 'footerWindowID', 'layout', 'strModal_Ok', 'strModal_Cancel', 'strModal_Text', { true, { 'overlayIcons', 'id', 'icon' } },
