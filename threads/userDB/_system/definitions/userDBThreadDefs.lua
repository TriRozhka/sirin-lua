...
---@class (exact) Sirin
---@field NATS NATS
---@field userDBThread userDBThread
...
---@class (exact) userDBThread
---@field g_UserDatabaseEx CUserSQLDatabase
local userDBThread = {}
...
---@class (exact) CUserSQLDatabase: CSQLDatabase
local CUserSQLDatabase = {}
...
Sirin.userDBThread = userDBThread
