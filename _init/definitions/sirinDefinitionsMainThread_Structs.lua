...
---@param val integer
---@return integer
function _force_fld:m_nContEffectSec_set(index, val) end
...
---@param val integer
---@return integer
function _skill_fld:m_nContEffectSec_set(index, val) end
...
function _ItemMakeData_fld:m_listMaterial_get(index) end
---@param index integer
---@return _ItemMakeData_fld___output_list
function _ItemMakeData_fld:m_listOutput_get(index) end