local socketExtender = {}

socketExtender.combineChecker = function(ppConMats)
	repeat
		if #ppConMats > 2 then
			break
		end
...
socketExtender.combineWorker = function(pPlayer, ppConMats, pipMats, pSend)
